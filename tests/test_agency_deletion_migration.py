"""Migration proof for a1d3f5b7c9e2 (agency_deletion_log): additive,
RLS enabled (post-sweep rule), clean roundtrip on a testcontainer."""
...
def test_agency_deletion_log_roundtrip(alembic_db) -> None:
