"""Migration proof for f5d2b8e4c1a6 (agency.cover_path): additive
        ...
        return bool(
            c.execute(
                text(
                    ...
                    " WHERE table_name = 'agency' AND column_name = 'cover_path'"
                )
            ).scalar()
        )


def test_cover_path_roundtrip(alembic_db) -> None:
